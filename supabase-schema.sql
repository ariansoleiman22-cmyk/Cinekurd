...
-- CreateIndex
CREATE INDEX "Product_subtype_idx" ON "Product"("subtype");

-- CreateIndex
CREATE INDEX "Product_brandId_idx" ON "Product"("brandId");

-- CreateIndex
CREATE INDEX "Message_threadUserId_idx" ON "Message"("threadUserId");
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_threadUserId_fkey" FOREIGN KEY ("threadUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
